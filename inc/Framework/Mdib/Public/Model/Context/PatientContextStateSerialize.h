...
#include <Framework/Mdib/Public/Model/Context/PatientDemographicsCoreDataSerialize.h>
...
BOOST_SERIALIZATION_SPLIT_FREE(::DFL::Mdib::PatientContextState)

BOOST_CLASS_VERSION(::DFL::Mdib::PatientContextState, 1)

BOOST_CLASS_TRACKING(::DFL::Mdib::PatientContextState, boost::serialization::track_never)
...
void save(Archive& ar, const ::DFL::Mdib::PatientContextState& src, const unsigned int /*fileVersion*/)
{
    ...
    const auto& patientDemographicsCoreData = src.patientDemographicsCoreData();
    ar & make_nvp("PatientDemographicsCoreData", patientDemographicsCoreData);
 ...
 */
template<class Archive>
void load_construct_data(Archive& ar, ::DFL::Mdib::PatientContextState* dst, const unsigned int version)
{
    ...
    boost::optional<::DFL::Mdib::PatientDemographicsCoreData> patientDemographicsCoreData{};
    ar & make_nvp("PatientDemographicsCoreData", patientDemographicsCoreData);
    ...
    ::new(dst) ::DFL::Mdib::PatientContextState(
        category,
        contextAssociation,
        bindingMdibVersion,
 ...
 */
template<class Archive>
void load(Archive& /*ar*/, ::DFL::Mdib::PatientContextState& /*dst*/, const unsigned int /*version*/)
{
}
