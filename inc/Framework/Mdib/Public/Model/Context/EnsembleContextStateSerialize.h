...
BOOST_SERIALIZATION_SPLIT_FREE(::DFL::Mdib::EnsembleContextState)

BOOST_CLASS_VERSION(::DFL::Mdib::EnsembleContextState, 0)

BOOST_CLASS_TRACKING(::DFL::Mdib::EnsembleContextState, boost::serialization::track_never)
...
void save(Archive& ar, const ::DFL::Mdib::EnsembleContextState& src, const unsigned int /*fileVersion*/)
{
 ...
 */
template<class Archive>
void load_construct_data(Archive& ar, ::DFL::Mdib::EnsembleContextState* dst, const unsigned int /*version*/)
{
    ...
    ::new(dst) ::DFL::Mdib::EnsembleContextState(
        category,
        contextAssociation,
        bindingMdibVersion,
 ...
 */
template<class Archive>
void load(Archive& /*ar*/, ::DFL::Mdib::EnsembleContextState& /*dst*/, const unsigned int /*version*/)
{
}
