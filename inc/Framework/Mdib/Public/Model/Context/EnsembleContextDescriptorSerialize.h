...
BOOST_SERIALIZATION_SPLIT_FREE(::DFL::Mdib::EnsembleContextDescriptor)

BOOST_CLASS_VERSION(::DFL::Mdib::EnsembleContextDescriptor, 0)

BOOST_CLASS_TRACKING(::DFL::Mdib::EnsembleContextDescriptor, boost::serialization::track_never)
...
void save(Archive& ar, const ::DFL::Mdib::EnsembleContextDescriptor& src, const unsigned int /*fileVersion*/)
{
 ...
 */
template<class Archive>
void load_construct_data(Archive& ar, ::DFL::Mdib::EnsembleContextDescriptor* dst, const unsigned int /*version*/)
{
    ...
    ::new(dst) ::DFL::Mdib::EnsembleContextDescriptor(
 ...
 */
template<class Archive>
void load(Archive& /*ar*/, ::DFL::Mdib::EnsembleContextDescriptor& /*dst*/, const unsigned int /*version*/)
{
}
