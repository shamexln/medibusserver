...
BOOST_SERIALIZATION_SPLIT_FREE(::DFL::Mdib::VmdState)

BOOST_CLASS_VERSION(::DFL::Mdib::VmdState, 0)

BOOST_CLASS_TRACKING(::DFL::Mdib::VmdState, boost::serialization::track_never)
...
void save(Archive& ar, const ::DFL::Mdib::VmdState& src, const unsigned int /*fileVersion*/)
{
 ...
 */
template<class Archive>
void load_construct_data(Archive& ar, ::DFL::Mdib::VmdState* dst, const unsigned int /*version*/)
{
 ...
 */
template<class Archive>
void load(Archive& /*ar*/, ::DFL::Mdib::VmdState& /*dst*/, const unsigned int /*version*/)
{
}
