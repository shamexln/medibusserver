...
BOOST_SERIALIZATION_SPLIT_FREE(::DFL::Mdib::LimitAlertConditionDescriptor)

BOOST_CLASS_VERSION(::DFL::Mdib::LimitAlertConditionDescriptor, 0)

BOOST_CLASS_TRACKING(::DFL::Mdib::LimitAlertConditionDescriptor, boost::serialization::track_never)
...
void save(Archive& ar, const ::DFL::Mdib::LimitAlertConditionDescriptor& src, const unsigned int /*fileVersion*/)
{
    ...
    const auto& autoLimitSupported = src.autoLimitSupported();
    ar & make_nvp("AutoLimitSupported", autoLimitSupported);

    const auto& maxLimits = src.maxLimits();
    ar & make_nvp("MaxLimits", maxLimits);
 ...
 */
template<class Archive>
void load_construct_data(Archive& ar, ::DFL::Mdib::LimitAlertConditionDescriptor* dst, const unsigned int /*version*/)
{
    ...
    boost::optional<::DFL::Mdib::Range> maxLimits{};
    ar & make_nvp("MaxLimits", maxLimits);

    ::DFL::Mdib::ExtensionTypes extensions{};
    ar & make_nvp("Extensions", extensions);

    ::new(dst) ::DFL::Mdib::LimitAlertConditionDescriptor(
 ...
 */
template<class Archive>
void load(Archive& /*ar*/, ::DFL::Mdib::LimitAlertConditionDescriptor& /*dst*/, const unsigned int /*version*/)
{
}
