...
BOOST_SERIALIZATION_SPLIT_FREE(::DFL::Mdib::SetMetricStateOperationDescriptor)

BOOST_CLASS_VERSION(::DFL::Mdib::SetMetricStateOperationDescriptor, 0)

BOOST_CLASS_TRACKING(::DFL::Mdib::SetMetricStateOperationDescriptor, boost::serialization::track_never)
...
void save(Archive& ar, const ::DFL::Mdib::SetMetricStateOperationDescriptor& src, const unsigned int /*fileVersion*/)
{
 ...
 */
template<class Archive>
void load_construct_data(Archive& ar, ::DFL::Mdib::SetMetricStateOperationDescriptor* dst, const unsigned int /*version*/)
{
    ...
    ::new(dst) ::DFL::Mdib::SetMetricStateOperationDescriptor(
 ...
 */
template<class Archive>
void load(Archive& /*ar*/, ::DFL::Mdib::SetMetricStateOperationDescriptor& /*dst*/, const unsigned int /*version*/)
{
}
