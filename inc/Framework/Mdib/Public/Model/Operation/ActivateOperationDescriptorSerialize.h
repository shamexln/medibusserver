...
#include <Framework/Mdib/Public/Model/Operation/ActivateArgumentSerialize.h>
...
BOOST_SERIALIZATION_SPLIT_FREE(::DFL::Mdib::ActivateOperationDescriptor)

BOOST_CLASS_VERSION(::DFL::Mdib::ActivateOperationDescriptor, 0)

BOOST_CLASS_TRACKING(::DFL::Mdib::ActivateOperationDescriptor, boost::serialization::track_never)
...
void save(Archive& ar, const ::DFL::Mdib::ActivateOperationDescriptor& src, const unsigned int /*fileVersion*/)
{
    ...
    const auto& arguments = src.arguments();
    ar & make_nvp("Arguments", arguments);
 ...
 */
template<class Archive>
void load_construct_data(Archive& ar, ::DFL::Mdib::ActivateOperationDescriptor* dst, const unsigned int /*version*/)
{
    ...
    ::DFL::Mdib::ActivateArguments arguments{};
    ar & make_nvp("Arguments", arguments);

    ::DFL::Mdib::ExtensionTypes extensions{};
    ar & make_nvp("Extensions", extensions);

    ::new(dst) ::DFL::Mdib::ActivateOperationDescriptor(
 ...
 */
template<class Archive>
void load(Archive& /*ar*/, ::DFL::Mdib::ActivateOperationDescriptor& /*dst*/, const unsigned int /*version*/)
{
}
