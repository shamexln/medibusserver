...
BOOST_SERIALIZATION_SPLIT_FREE(::DFL::Mdib::StringMetricDescriptor)

BOOST_CLASS_VERSION(::DFL::Mdib::StringMetricDescriptor, 0)

BOOST_CLASS_TRACKING(::DFL::Mdib::StringMetricDescriptor, boost::serialization::track_never)
...
void save(Archive& ar, const ::DFL::Mdib::StringMetricDescriptor& src, const unsigned int /*fileVersion*/)
{
 ...
 */
template<class Archive>
void load_construct_data(Archive& ar, ::DFL::Mdib::StringMetricDescriptor* dst, const unsigned int /*version*/)
{
    ...
    ::new(dst) ::DFL::Mdib::StringMetricDescriptor(
 ...
 */
template<class Archive>
void load(Archive& /*ar*/, ::DFL::Mdib::StringMetricDescriptor& /*dst*/, const unsigned int /*version*/)
{
}
