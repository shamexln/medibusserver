...
#include <Framework/Mdib/Public/Model/Metric/AllowedEnumValueSerialize.h>
...
BOOST_SERIALIZATION_SPLIT_FREE(::DFL::Mdib::EnumStringMetricDescriptor)

BOOST_CLASS_VERSION(::DFL::Mdib::EnumStringMetricDescriptor, 0)

BOOST_CLASS_TRACKING(::DFL::Mdib::EnumStringMetricDescriptor, boost::serialization::track_never)
...
void save(Archive& ar, const ::DFL::Mdib::EnumStringMetricDescriptor& src, const unsigned int /*fileVersion*/)
{
 ...
 */
template<class Archive>
void load_construct_data(Archive& ar, ::DFL::Mdib::EnumStringMetricDescriptor* dst, const unsigned int /*version*/)
{
    ...
    ::DFL::Mdib::AllowedEnumValues allowedValues{};
    ar & make_nvp("AllowedValues", allowedValues);

    ::DFL::Mdib::ExtensionTypes extensions{};
    ar & make_nvp("Extensions", extensions);

    ::new(dst) ::DFL::Mdib::EnumStringMetricDescriptor(
 ...
 */
template<class Archive>
void load(Archive& /*ar*/, ::DFL::Mdib::EnumStringMetricDescriptor& /*dst*/, const unsigned int /*version*/)
{
}
