...
#include <Framework/Mdib/Public/Model/Metric/NumericMetricValueSerialize.h>
...
BOOST_SERIALIZATION_SPLIT_FREE(::DFL::Mdib::NumericMetricState)

BOOST_CLASS_VERSION(::DFL::Mdib::NumericMetricState, 0)

BOOST_CLASS_TRACKING(::DFL::Mdib::NumericMetricState, boost::serialization::track_never)
...
void save(Archive& ar, const ::DFL::Mdib::NumericMetricState& src, const unsigned int /*fileVersion*/)
{
    ...
    const auto& activeAveragingPeriod = src.activeAveragingPeriod();
    ar & make_nvp("ActiveAveragingPeriod", activeAveragingPeriod);
 ...
 */
template<class Archive>
void load_construct_data(Archive& ar, ::DFL::Mdib::NumericMetricState* dst, const unsigned int /*version*/)
{
    ...
    boost::optional<::DFL::Mdib::Duration> activeAveragingPeriod{};
    ar & make_nvp("ActiveAveragingPeriod", activeAveragingPeriod);

    boost::optional<::DFL::Mdib::NumericMetricValue> metricValue{};
    ar & make_nvp("MetricValue", metricValue);
    ...
    ::new(dst) ::DFL::Mdib::NumericMetricState(
        activationState,
 ...
 */
template<class Archive>
void load(Archive& /*ar*/, ::DFL::Mdib::NumericMetricState& /*dst*/, const unsigned int /*version*/)
{
}
