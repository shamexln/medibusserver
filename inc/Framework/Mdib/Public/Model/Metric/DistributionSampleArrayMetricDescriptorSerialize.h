...
BOOST_SERIALIZATION_SPLIT_FREE(::DFL::Mdib::DistributionSampleArrayMetricDescriptor)

BOOST_CLASS_VERSION(::DFL::Mdib::DistributionSampleArrayMetricDescriptor, 0)

BOOST_CLASS_TRACKING(::DFL::Mdib::DistributionSampleArrayMetricDescriptor, boost::serialization::track_never)
...
void save(Archive& ar, const ::DFL::Mdib::DistributionSampleArrayMetricDescriptor& src, const unsigned int /*fileVersion*/)
{
    ...
    const auto& domainUnit = src.domainUnit();
    ar & make_nvp("DomainUnit", domainUnit);

    const auto& distributionRange = src.distributionRange();
    ar & make_nvp("DistributionRange", distributionRange);
 ...
 */
template<class Archive>
void load_construct_data(Archive& ar, ::DFL::Mdib::DistributionSampleArrayMetricDescriptor* dst, const unsigned int /*version*/)
{
    ...
    ::DFL::Mdib::CodedValue domainUnit(::DFL::Mdib::CodingSystem{::DFL::Mdib::CodingSystemId{}}, ::DFL::Mdib::CodeId{});
    ar & make_nvp("DomainUnit", domainUnit);

    ::DFL::Mdib::Range distributionRange{};
    ar & make_nvp("DistributionRange", distributionRange);

    ::DFL::Mdib::ExtensionTypes extensions{};
    ar & make_nvp("Extensions", extensions);

    ::new(dst) ::DFL::Mdib::DistributionSampleArrayMetricDescriptor(
 ...
 */
template<class Archive>
void load(Archive& /*ar*/, ::DFL::Mdib::DistributionSampleArrayMetricDescriptor& /*dst*/, const unsigned int /*version*/)
{
}
