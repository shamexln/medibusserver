...
BOOST_SERIALIZATION_SPLIT_FREE(::DFL::Mdib::StringMetricValue)

BOOST_CLASS_VERSION(::DFL::Mdib::StringMetricValue, 0)

BOOST_CLASS_TRACKING(::DFL::Mdib::StringMetricValue, boost::serialization::track_never)
...
void save(Archive& ar, const ::DFL::Mdib::StringMetricValue& src, const unsigned int /*fileVersion*/)
{
 ...
 */
template<class Archive>
void load(Archive& ar, ::DFL::Mdib::StringMetricValue& dst, const unsigned int /*version*/)
{
    ...
    dst = ::DFL::Mdib::StringMetricValue(
        metricQuality,
        annotations,
        startTime,
        stopTime,
