...
BOOST_SERIALIZATION_SPLIT_FREE(::DFL::Mdib::RealTimeSampleArrayMetricState)

BOOST_CLASS_VERSION(::DFL::Mdib::RealTimeSampleArrayMetricState, 0)

BOOST_CLASS_TRACKING(::DFL::Mdib::RealTimeSampleArrayMetricState, boost::serialization::track_never)
...
void save(Archive& ar, const ::DFL::Mdib::RealTimeSampleArrayMetricState& src, const unsigned int /*fileVersion*/)
{
 ...
 */
template<class Archive>
void load_construct_data(Archive& ar, ::DFL::Mdib::RealTimeSampleArrayMetricState* dst, const unsigned int /*version*/)
{
    ...
    ::new(dst) ::DFL::Mdib::RealTimeSampleArrayMetricState(
        activationState,
        std::move(activeDeterminationPeriod),
        std::move(lifeTimePeriod),
        std::move(bodySites),
        std::move(physicalConnector),
        std::move(metricValue),
        std::move(physiologicalRanges),
        std::move(extensions));
}
 ...
 */
template<class Archive>
void load(Archive& /*ar*/, ::DFL::Mdib::RealTimeSampleArrayMetricState& /*dst*/, const unsigned int /*version*/)
{
}
